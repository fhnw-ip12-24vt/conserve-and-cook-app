...
CREATE TABLE IF NOT EXISTS "ingredient" (
                                            ...
                                            comment TEXT
, identifier TEXT);
INSERT INTO ingredient VALUES(0,'Rindfleisch',13300,'Aber Achtung: Rindfleisch verursacht besonders viel CO₂ wegen der Methan-Emissionen. Vielleicht findest du eine klimafreundlichere Alternative?','034');
...
INSERT INTO ingredient VALUES(2,'Falafel',2500,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig','014');
INSERT INTO ingredient VALUES(3,'Käse',8500,'Aber Käse braucht viel Milch, und das verursacht leider ziemlich viel CO₂. Für das Klima wäre eine pflanzliche Alternative vielleicht die bessere Wahl. Probier dich doch mal durch!','022');
INSERT INTO ingredient VALUES(4,'Ananas',15100,'Aber Ananas kommt meist von weit her und wird gekühlt transportiert.Das ist für’s Klima eher ungünstig. Vielleicht findest du etwas, das näher wächst?','001');
...
INSERT INTO ingredient VALUES(6,'Tomate',200,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','044');
INSERT INTO ingredient VALUES(7,'Salat',425,'Deine Zutatenwahl ist top für dich und die Umwelt.','036');
INSERT INTO ingredient VALUES(8,'Zwiebel',420,'Deine Zutatenwahl ist top für dich und die Umwelt.','046');
INSERT INTO ingredient VALUES(9,'Bohnen',1050,'Du bist sehr klimafreundlich unterwegs - weiter so!','008');
INSERT INTO ingredient VALUES(10,'Mais',1500,'Nur so als Hinweis: Der Anbau von Mais braucht viel Wasser. Vielleicht findest du beim nächsten Mal eine klimafreundlichere Variante.','027');
INSERT INTO ingredient VALUES(16,'Avocado',846,'Du bist sehr klimafreundlich unterwegs - weiter so!','004');
INSERT INTO ingredient VALUES(17,'Knoblauch',415,replace('Du hast richtig klimafreundlich ausgewählt. Weiter so!\n','\n',char(10)),'024');
INSERT INTO ingredient VALUES(21,'Sahne',7600,'Nur: Sahne ist ein Milchprodukt mit viel Energieaufwand. Eine leichtere Alternative wäre vielleicht auch lecker.','035');
INSERT INTO ingredient VALUES(22,'Erdbeer',300,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','013');
INSERT INTO ingredient VALUES(23,'Eier',1950,'Aber Eier tragen wegen der Hühnerhaltung doch mehr zur Klimaerwärmung bei, als viele denken.','012');
INSERT INTO ingredient VALUES(24,'Knoblauchsauce',2800,'Du bist sehr klimafreundlich unterwegs - weiter so!','025');
INSERT INTO ingredient VALUES(25,'Banane',110,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','007');
INSERT INTO ingredient VALUES(27,'Schokolade',13800,'Nur ein kleiner Hinweis: Schokolade entsteht aus Kakao, Milch und braucht viel Transport. Für das Klima ist sie leider nicht die beste Wahl – aber ab und zu ist Naschen auch okay.','038');
INSERT INTO ingredient VALUES(28,'Tofu',2100,'Mia mag Tofu-Rezepte! Zwar braucht die Herstellung einiges an Wasser und Energie, aber er ist trotzdem oft besser als Fleisch. Weiter so!','043');
...
INSERT INTO ingredient VALUES(34,'Reis',6000,'Beim Reisanbau entstehen viele Treibhausgase. Deshalb greifen viele lieber zu Hirse','033');
INSERT INTO ingredient VALUES(35,'Nudeln',1300,'Du bist sehr klimafreundlich unterwegs - weiter so!','029');
INSERT INTO ingredient VALUES(36,'Fladenbrot',1600,' Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','015');
INSERT INTO ingredient VALUES(40,'Heuschrecken',2500,'Du bist sehr klimafreundlich unterwegs - weiter so!','017');
INSERT INTO ingredient VALUES(41,'Champignon',1300,'Du bist sehr klimafreundlich unterwegs - weiter so!','010');
INSERT INTO ingredient VALUES(46,'Quinoa',2500,'Du bist sehr klimafreundlich unterwegs - weiter so!','032');
...
INSERT INTO ingredient VALUES(50,'Kaviar',10000,'Aber Achtung: Kaviar ist extrem aufwendig in der Herstellung und hat einen sehr hohen CO₂-Ausstoß. Fürs Klima wäre etwas Einfacheres besser.','023');
INSERT INTO ingredient VALUES(51,'Karotten',390,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','020');
INSERT INTO ingredient VALUES(53,'Ingwer',401,replace('Du hast richtig klimafreundlich ausgewählt. Weiter so!\n','\n',char(10)),'018');
INSERT INTO ingredient VALUES(54,'Sojasauce',2100,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','040');
INSERT INTO ingredient VALUES(55,'Wasabi',1500,'Nur so als Hinweis: Der Anbau von Mais braucht viel Wasser. Vielleicht findest du beim nächsten Mal eine klimafreundlichere Variante.','045');
...
INSERT INTO ingredient VALUES(62,'Kapern',388,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.! Du hast dich für eine klimafreundliche Zutat entschieden – weiter so! ','019');
...
INSERT INTO ingredient VALUES(72,'Cocktailsauce',2700,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','011');
INSERT INTO ingredient VALUES(79,'Olive',1400,'Du bist sehr klimafreundlich unterwegs - weiter so!','030');
INSERT INTO ingredient VALUES(82,'Artischocken',394,'Dein Rezept ist nicht nur lecker, sondern auch richtig nachhaltig.','002');
COMMIT;
